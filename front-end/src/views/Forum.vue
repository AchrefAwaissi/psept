    ...
    <main class="container">    
        <div class="col-12">
            <div class="col-12 ">
                ...
                <h1  v-else class='col-12 my-2 btn  btn-block btn-danger font-weight-bold' style="cursor:default"> Aucune publication creer votre premiere post! </h1>
            </div>
...
.btn-block {
    color: white;
    background-color: rgb(92, 107, 243);
}
.btn-block:hover {
    color: white;
